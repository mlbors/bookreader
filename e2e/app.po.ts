...
export class BookreaderPage {
  ...
  /***********************************************/
  /********** IS FOOTER ELEMENT PRESENT **********/
  /***********************************************/

  isFooterElementPresent() {
  ...
  getFooter() {
    return element(by.css('app-root app-footer'));
  }
  ...
  getFooterContentElement() {
    return element(by.css('app-root app-footer p.content'));
  }
  ...
  getFooterContent() {
    return element(by.css('app-root app-footer p.content')).getText();
  }
